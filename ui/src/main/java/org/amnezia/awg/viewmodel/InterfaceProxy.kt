...
class InterfaceProxy : BaseObservable, Parcelable {
    ...
    constructor(other: Interface) {
        ...
        junkPacketCount = other.junkPacketCount?.toString() ?: ""
        junkPacketMinSize = other.junkPacketMinSize?.toString() ?: ""
        junkPacketMaxSize = other.junkPacketMaxSize?.toString() ?: ""
        initPacketJunkSize = other.initPacketJunkSize?.toString() ?: ""
        responsePacketJunkSize = other.responsePacketJunkSize?.toString() ?: ""
        cookieReplyPacketJunkSize = other.cookieReplyPacketJunkSize?.toString() ?: ""
        transportPacketJunkSize = other.transportPacketJunkSize?.toString() ?: ""
        ...
        specialJunkI1 = other.specialJunkI1 ?: ""
        specialJunkI2 = other.specialJunkI2 ?: ""
        specialJunkI3 = other.specialJunkI3 ?: ""
        specialJunkI4 = other.specialJunkI4 ?: ""
        specialJunkI5 = other.specialJunkI5 ?: ""
